...
class Clockwork {
  ...
  */
  public function __construct($key = "", array $options = array()) {
    ...
    $key = empty($key) ? Config::get('application.clockwork_api') : $key;
    ...
    $options = is_array($options) ? $options : Config::get('application.clockwork_options');
  ...
  static function message(array $sms){
    $clockwork = new self;
    return $clockwork->send($sms);
  }
