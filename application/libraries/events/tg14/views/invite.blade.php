...
<div class="login-page">	
	<div class="login-wrapper">
		<form id="form-login" action="{{ url('/invite') }}" method="post">
			...
			<h3>Invitiation to use Objekt for<br />The Gathering 2014</h3>
			<p>
				As a member of <b>Core:SponsorSupport</b> or <b>Info:Desk</b> you are eligible to create an account on Objekt for The Gathering 2014. You will be granted a user-role based on what crew you a part of.<br /><br />We would like you to take note that we only save the password you enter here, and do not synchronize with Wannabe any time later.<br /><br />
				To create an account, you need to enter your <a href="http://wannabe.gathering.org/tg14" target="_blank">Wannabe</a> account details below. This can only be done once.
			</p>
			<hr>
